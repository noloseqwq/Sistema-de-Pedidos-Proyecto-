            ...
            <ul class="full-box list-unstyled page-nav-tabs">
                    ...
                    <li>
                        <a  class="active" href="<?php echo SERVER_URL; ?>pending-order-list/"><i class="fas fa-hourglass-half"></i> &nbsp; PEDIDOS PENDIENTES</a>
                    </li>
                    <li>
            ...
            <?php
					...
					echo $ins_pedidoTab->paginador_pedido_controlador($pagina[1],8, $_SESSION['privilegio_sdp'],$pagina[0],"Pendiente","");
